...
from ..shared.ntdef import PVOID64, PVOID, LONGLONG, ULONGLONG
...
class SERVICE_NODE_TYPE(IntEnum):
...
class SERVICE_LOAD_TYPE(IntEnum):
...
class SERVICE_ERROR_TYPE(IntEnum):
...
class TAPE_DRIVE_PROBLEM_TYPE(IntEnum):
